...
public class RCNLCostTermsInfo {
    static String[][] trackingCostTerms= {
        {"generalized_coordinate_tracking", "generalized_speed_tracking", "generalized_acceleration_tracking", "generalized_acceleration_minimization", 
            "marker_position_tracking", "marker_velocity_tracking", "body_orientation_tracking", "body_orientation_minimization",
            ...
            "muscle_activation_tracking", "muscle_activation_minimization", "synergy_vector_tracking", 
            "controller_tracking", "controller_minimization", "controller_slope_minimization"},
        {"coordinate", "coordinate", "coordinate", "coordinate", 
            "marker", "marker", "body", "body",
            "load", "load" , "load", 
            "force", "moment", 
            "muscle", "muscle", "synergy", 
    ...
    static String[][] verificationCostTerms= {
        {"controller_tracking", "generalized_coordinate_tracking", "generalized_speed_tracking", "generalized_acceleration_tracking", 
        "generalized_acceleration_minimization", "marker_position_tracking", "marker_velocity_tracking", "body_orientation_tracking"},
        {"controller", "coordinate", "coordinate", "coordinate", 
        "coordinate", "marker", "marker", "body"},
        {"N", "N", "N", "N", 
            "N", "N", "N", "N"}
    };
    static String[][] designOptimizationCostTerms= {
        {"generalized_coordinate_tracking", "generalized_speed_tracking", "generalized_acceleration_tracking", "generalized_acceleration_minimization", 
            ...
            "muscle_activation_tracking", "muscle_activation_minimization", "synergy_vector_tracking",  
            "controller_tracking", "controller_minimization", "controller_slope_minimization", 
            "controller_shape_tracking", "joint_energy_generation_goal", "joint_energy_absorption_goal", 
            "inverse_dynamics_shape_tracking", "angular_momentum_minimization", "relative_walking_speed_goal", 
            "absolute_metabolic_cost_per_time", "absolute_metabolic_cost_per_distance", "relative_metabolic_cost_per_time", "relative_metabolic_cost_per_distance",
            "propulsive_impulse_goal", "braking_impulse_goal"},
        {"coordinate", "coordinate", "coordinate", "coordinate", 
            "marker", "marker", "body", "body",
            "load", "load" , "load", 
            "force", "moment",
