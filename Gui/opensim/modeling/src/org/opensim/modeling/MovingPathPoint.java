...
public class MovingPathPoint extends AbstractPathPoint {
  ...
  public static long swigRelease(MovingPathPoint obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setPropertyIndex_socket_x_coordinate(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_x_coordinate_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_x_coordinate() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_x_coordinate_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_socket_y_coordinate(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_y_coordinate_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_y_coordinate() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_y_coordinate_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_socket_z_coordinate(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_z_coordinate_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_z_coordinate() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.MovingPathPoint_PropertyIndex_socket_z_coordinate_get(swigCPtr, this), true);
  }
