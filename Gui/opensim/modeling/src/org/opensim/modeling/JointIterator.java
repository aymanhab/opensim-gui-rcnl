...
public class JointIterator {
  ...
  public static long swigRelease(JointIterator obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_parent_frame() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.JointIterator_PropertyIndex_socket_parent_frame_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_child_frame() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.JointIterator_PropertyIndex_socket_child_frame_get(swigCPtr, this), true);
  }
  ...
  public boolean isComponentInOwnershipTree(Component component) {
    return opensimSimulationJNI.JointIterator_isComponentInOwnershipTree(swigCPtr, this, Component.getCPtr(component), component);
  }
  ...
  public ComponentPath getAbsolutePath() {
    return new ComponentPath(opensimSimulationJNI.JointIterator_getAbsolutePath(swigCPtr, this), true);
  }

  public String getRelativePathString(Component wrt) {
    return opensimSimulationJNI.JointIterator_getRelativePathString(swigCPtr, this, Component.getCPtr(wrt), wrt);
  }

  public ComponentPath getRelativePath(Component wrt) {
    return new ComponentPath(opensimSimulationJNI.JointIterator_getRelativePath(swigCPtr, this, Component.getCPtr(wrt), wrt), true);
  }
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimSimulationJNI.JointIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimSimulationJNI.JointIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public StdVectorString getSocketNames() {
    return new StdVectorString(opensimSimulationJNI.JointIterator_getSocketNames(swigCPtr, this), true);
  }

  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.JointIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.JointIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }

  public AbstractSocket tryGetSocket(String name) {
    long cPtr = opensimSimulationJNI.JointIterator_tryGetSocket(swigCPtr, this, name);
  ...
  public AbstractOutput tryGetOutput(String name) {
    long cPtr = opensimSimulationJNI.JointIterator_tryGetOutput(swigCPtr, this, name);
  ...
  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimSimulationJNI.JointIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimSimulationJNI.JointIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.JointIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimSimulationJNI.JointIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.JointIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public SWIGTYPE_p_SimTK__CacheEntryIndex getCacheVariableIndex(String name) {
    return new SWIGTYPE_p_SimTK__CacheEntryIndex(opensimSimulationJNI.JointIterator_getCacheVariableIndex(swigCPtr, this, name), true);
  }
  ...
  public Component getRoot() {
    return new Component(opensimSimulationJNI.JointIterator_getRoot(swigCPtr, this), false);
  }

  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimSimulationJNI.JointIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimSimulationJNI.JointIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
