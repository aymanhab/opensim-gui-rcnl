...
public class MuscleIterator {
  ...
  public static long swigRelease(MuscleIterator obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public AbstractGeometryPath get_path(int i) {
    return new AbstractGeometryPath(opensimSimulationJNI.MuscleIterator_get_path__SWIG_0(swigCPtr, this, i), false);
  }

  public AbstractGeometryPath get_path() {
    return new AbstractGeometryPath(opensimSimulationJNI.MuscleIterator_get_path__SWIG_1(swigCPtr, this), false);
  }
  ...
  public AbstractGeometryPath getPath() {
    return new AbstractGeometryPath(opensimSimulationJNI.MuscleIterator_getPath(swigCPtr, this), false);
  }
  ...
  public void produceForces(State state, SWIGTYPE_p_OpenSim__ForceConsumer forceConsumer) {
    opensimSimulationJNI.MuscleIterator_produceForces(swigCPtr, this, State.getCPtr(state), state, SWIGTYPE_p_OpenSim__ForceConsumer.getCPtr(forceConsumer));
  }
  ...
  public SWIGTYPE_p_SimTK__ForceIndex getForceIndex() {
    return new SWIGTYPE_p_SimTK__ForceIndex(opensimSimulationJNI.MuscleIterator_getForceIndex(swigCPtr, this), true);
  }
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimSimulationJNI.MuscleIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimSimulationJNI.MuscleIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public StdVectorString getSocketNames() {
    return new StdVectorString(opensimSimulationJNI.MuscleIterator_getSocketNames(swigCPtr, this), true);
  }

  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.MuscleIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.MuscleIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }

  public AbstractSocket tryGetSocket(String name) {
    long cPtr = opensimSimulationJNI.MuscleIterator_tryGetSocket(swigCPtr, this, name);
  ...
  public AbstractOutput tryGetOutput(String name) {
    long cPtr = opensimSimulationJNI.MuscleIterator_tryGetOutput(swigCPtr, this, name);
  ...
  public int getModelingOption(State state, String path) {
    return opensimSimulationJNI.MuscleIterator_getModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public int getModelingOption(State state, ComponentPath path) {
    return opensimSimulationJNI.MuscleIterator_getModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public void setModelingOption(State state, String path, int flag) {
    opensimSimulationJNI.MuscleIterator_setModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path, flag);
  }

  public void setModelingOption(State state, ComponentPath path, int flag) {
    opensimSimulationJNI.MuscleIterator_setModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path, flag);
  }

  public double getStateVariableValue(State state, String name) {
    return opensimSimulationJNI.MuscleIterator_getStateVariableValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableValue(State state, ComponentPath path) {
    return opensimSimulationJNI.MuscleIterator_getStateVariableValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }
  ...
  public double getStateVariableDerivativeValue(State state, String name) {
    return opensimSimulationJNI.MuscleIterator_getStateVariableDerivativeValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableDerivativeValue(State state, ComponentPath path) {
    return opensimSimulationJNI.MuscleIterator_getStateVariableDerivativeValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimSimulationJNI.MuscleIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimSimulationJNI.MuscleIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.MuscleIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimSimulationJNI.MuscleIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.MuscleIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public SWIGTYPE_p_SimTK__CacheEntryIndex getCacheVariableIndex(String name) {
    return new SWIGTYPE_p_SimTK__CacheEntryIndex(opensimSimulationJNI.MuscleIterator_getCacheVariableIndex(swigCPtr, this, name), true);
  }
  ...
  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimSimulationJNI.MuscleIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimSimulationJNI.MuscleIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
