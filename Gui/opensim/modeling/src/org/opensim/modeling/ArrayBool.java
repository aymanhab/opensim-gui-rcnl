...
public class ArrayBool {
  ...
  public ArrayBool(boolean aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayBool__SWIG_2(aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayBool(boolean aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayBool__SWIG_3(aDefaultValue, aSize), true);
  }

  public ArrayBool(boolean aDefaultValue) {
    this(opensimCommonJNI.new_ArrayBool__SWIG_4(aDefaultValue), true);
  }

  public ArrayBool() {
    this(opensimCommonJNI.new_ArrayBool__SWIG_5(), true);
  }
