...
public class PinJoint extends Joint {
  ...
  public static long swigRelease(PinJoint obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Coordinate getCoordinate() {
    return new Coordinate(opensimSimulationJNI.PinJoint_getCoordinate__SWIG_0(swigCPtr, this), false);
  }

  public Coordinate updCoordinate() {
    return new Coordinate(opensimSimulationJNI.PinJoint_updCoordinate__SWIG_0(swigCPtr, this), false);
  }
