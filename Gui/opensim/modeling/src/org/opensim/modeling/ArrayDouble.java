...
public class ArrayDouble {
  ...
  public ArrayDouble(SWIGTYPE_p_std__initializer_listT_double_t initList) {
    this(opensimCommonJNI.new_ArrayDouble__SWIG_2(SWIGTYPE_p_std__initializer_listT_double_t.getCPtr(initList)), true);
  }

  public ArrayDouble(double aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayDouble__SWIG_3(aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayDouble(double aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayDouble__SWIG_4(aDefaultValue, aSize), true);
  }

  public ArrayDouble(double aDefaultValue) {
    this(opensimCommonJNI.new_ArrayDouble__SWIG_5(aDefaultValue), true);
  }

  public ArrayDouble() {
    this(opensimCommonJNI.new_ArrayDouble__SWIG_6(), true);
  }
