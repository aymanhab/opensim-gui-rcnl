...
public class BushingForce extends TwoFrameLinkerForce {
  ...
  public void set_has_output_statebounds_dissipated_energy(boolean value) {
    opensimSimulationJNI.BushingForce__has_output_statebounds_dissipated_energy_set(swigCPtr, this, value);
  }

  public boolean get_has_output_statebounds_dissipated_energy() {
    return opensimSimulationJNI.BushingForce__has_output_statebounds_dissipated_energy_get(swigCPtr, this);
  }
  ...
  public double getDissipatedEnergy(State state) {
    return opensimSimulationJNI.BushingForce_getDissipatedEnergy(swigCPtr, this, State.getCPtr(state), state);
  }

  public void setDissipatedEnergy(State state, double value) {
    opensimSimulationJNI.BushingForce_setDissipatedEnergy(swigCPtr, this, State.getCPtr(state), state, value);
  }

  public double getPowerDissipation(State state) {
    return opensimSimulationJNI.BushingForce_getPowerDissipation(swigCPtr, this, State.getCPtr(state), state);
  }

  public Vec2 getBoundsDissipatedEnergy(State arg0) {
    return new Vec2(opensimSimulationJNI.BushingForce_getBoundsDissipatedEnergy(swigCPtr, this, State.getCPtr(arg0), arg0), true);
  }
