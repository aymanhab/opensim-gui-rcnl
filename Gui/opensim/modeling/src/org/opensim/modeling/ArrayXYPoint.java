...
public class ArrayXYPoint {
  ...
  public ArrayXYPoint(XYPoint aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_2(XYPoint.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayXYPoint(XYPoint aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_3(XYPoint.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayXYPoint(XYPoint aDefaultValue) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_4(XYPoint.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayXYPoint() {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_5(), true);
  }
