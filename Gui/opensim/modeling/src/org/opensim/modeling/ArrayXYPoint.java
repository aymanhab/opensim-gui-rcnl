...
public class ArrayXYPoint {
  ...
  public static long swigRelease(ArrayXYPoint obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ArrayXYPoint(ArrayXYPoint arg0) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_0(ArrayXYPoint.getCPtr(arg0), arg0), true);
  }

  public ArrayXYPoint(SWIGTYPE_p_std__initializer_listT_OpenSim__XYPoint_t initList) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_2(SWIGTYPE_p_std__initializer_listT_OpenSim__XYPoint_t.getCPtr(initList)), true);
  }

  public ArrayXYPoint(XYPoint aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_3(XYPoint.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayXYPoint(XYPoint aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_4(XYPoint.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayXYPoint(XYPoint aDefaultValue) {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_5(XYPoint.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayXYPoint() {
    this(opensimCommonJNI.new_ArrayXYPoint__SWIG_6(), true);
  }
