...
public class Millard2012EquilibriumMuscleIterator {
  ...
  public SWIGTYPE_p_SimTK__ForceIndex getForceIndex() {
    return new SWIGTYPE_p_SimTK__ForceIndex(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getForceIndex(swigCPtr, this), true);
  }
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }

  public AbstractSocket tryGetSocket(String name) {
    long cPtr = opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_tryGetSocket(swigCPtr, this, name);
  ...
  public AbstractOutput tryGetOutput(String name) {
    long cPtr = opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_tryGetOutput(swigCPtr, this, name);
  ...
  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }
  ...
  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimSimulationJNI.Millard2012EquilibriumMuscleIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
