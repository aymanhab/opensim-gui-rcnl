...
public class SimTKArrayVec3 {
  ...
  public static long swigRelease(SimTKArrayVec3 obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t crbegin() {
    return new SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t(opensimSimbodyJNI.SimTKArrayVec3_crbegin(swigCPtr, this), true);
  }

  public SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t rbegin() {
    return new SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t(opensimSimbodyJNI.SimTKArrayVec3_rbegin__SWIG_0(swigCPtr, this), true);
  }

  public SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t crend() {
    return new SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t(opensimSimbodyJNI.SimTKArrayVec3_crend(swigCPtr, this), true);
  }

  public SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t rend() {
    return new SWIGTYPE_p_std__reverse_iteratorT_SimTK__VecT_3_t_const_p_t(opensimSimbodyJNI.SimTKArrayVec3_rend__SWIG_0(swigCPtr, this), true);
  }
