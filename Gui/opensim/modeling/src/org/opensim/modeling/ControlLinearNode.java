...
public class ControlLinearNode extends OpenSimObject {
  ...
  public static long swigRelease(ControlLinearNode obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean isEqual(ControlLinearNode aControl) {
    return opensimSimulationJNI.ControlLinearNode_isEqual(swigCPtr, this, ControlLinearNode.getCPtr(aControl), aControl);
  }

  public boolean isLessThan(ControlLinearNode aControl) {
    return opensimSimulationJNI.ControlLinearNode_isLessThan(swigCPtr, this, ControlLinearNode.getCPtr(aControl), aControl);
  }
