...
public class TwoFrameLinkerForce extends Force {
  ...
  public static long swigRelease(TwoFrameLinkerForce obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setPropertyIndex_socket_frame1(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.TwoFrameLinkerForce_PropertyIndex_socket_frame1_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_frame1() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.TwoFrameLinkerForce_PropertyIndex_socket_frame1_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_socket_frame2(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.TwoFrameLinkerForce_PropertyIndex_socket_frame2_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_frame2() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.TwoFrameLinkerForce_PropertyIndex_socket_frame2_get(swigCPtr, this), true);
  }
