...
public class FrameIterator {
  ...
  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.FrameIterator_getConnectee__SWIG_2(swigCPtr, this, name), false);
  }
  ...
  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.FrameIterator_getConnectee__SWIG_3(swigCPtr, this, name, index), false);
  }
