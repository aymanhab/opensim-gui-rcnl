...
public class FrameIterator {
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimSimulationJNI.FrameIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimSimulationJNI.FrameIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.FrameIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.FrameIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }

  public AbstractSocket tryGetSocket(String name) {
    long cPtr = opensimSimulationJNI.FrameIterator_tryGetSocket(swigCPtr, this, name);
  ...
  public AbstractOutput tryGetOutput(String name) {
    long cPtr = opensimSimulationJNI.FrameIterator_tryGetOutput(swigCPtr, this, name);
  ...
  public int getModelingOption(State state, String path) {
    return opensimSimulationJNI.FrameIterator_getModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public int getModelingOption(State state, ComponentPath path) {
    return opensimSimulationJNI.FrameIterator_getModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public void setModelingOption(State state, String path, int flag) {
    opensimSimulationJNI.FrameIterator_setModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path, flag);
  }

  public void setModelingOption(State state, ComponentPath path, int flag) {
    opensimSimulationJNI.FrameIterator_setModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path, flag);
  }
  ...
  public double getStateVariableDerivativeValue(State state, String name) {
    return opensimSimulationJNI.FrameIterator_getStateVariableDerivativeValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableDerivativeValue(State state, ComponentPath path) {
    return opensimSimulationJNI.FrameIterator_getStateVariableDerivativeValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimSimulationJNI.FrameIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimSimulationJNI.FrameIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.FrameIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimSimulationJNI.FrameIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.FrameIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }
  ...
  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimSimulationJNI.FrameIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimSimulationJNI.FrameIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
