...
public class OutputDouble extends AbstractOutput {
  ...
  public static long swigRelease(OutputDouble obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_std__mapT_std__string_OpenSim__OutputT_double_t__Channel_std__lessT_std__string_t_t getChannels() {
    return new SWIGTYPE_p_std__mapT_std__string_OpenSim__OutputT_double_t__Channel_std__lessT_std__string_t_t(opensimCommonJNI.OutputDouble_getChannels(swigCPtr, this), false);
  }
