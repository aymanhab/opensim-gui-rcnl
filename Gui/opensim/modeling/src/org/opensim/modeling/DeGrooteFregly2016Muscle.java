...
public class DeGrooteFregly2016Muscle extends Muscle {
  ...
  public void copyProperty_activation_dynamics_smoothing(DeGrooteFregly2016Muscle source) {
    opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_copyProperty_activation_dynamics_smoothing(swigCPtr, this, DeGrooteFregly2016Muscle.getCPtr(source), source);
  }

  public double get_activation_dynamics_smoothing(int i) {
    return opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_get_activation_dynamics_smoothing__SWIG_0(swigCPtr, this, i);
  }

  public SWIGTYPE_p_double upd_activation_dynamics_smoothing(int i) {
    return new SWIGTYPE_p_double(opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_upd_activation_dynamics_smoothing__SWIG_0(swigCPtr, this, i), false);
  }

  public void set_activation_dynamics_smoothing(int i, double value) {
    opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_set_activation_dynamics_smoothing__SWIG_0(swigCPtr, this, i, value);
  }

  public int append_activation_dynamics_smoothing(double value) {
    return opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_append_activation_dynamics_smoothing(swigCPtr, this, value);
  }

  public void constructProperty_activation_dynamics_smoothing(double initValue) {
    opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_constructProperty_activation_dynamics_smoothing(swigCPtr, this, initValue);
  }

  public double get_activation_dynamics_smoothing() {
    return opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_get_activation_dynamics_smoothing__SWIG_1(swigCPtr, this);
  }

  public SWIGTYPE_p_double upd_activation_dynamics_smoothing() {
    return new SWIGTYPE_p_double(opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_upd_activation_dynamics_smoothing__SWIG_1(swigCPtr, this), false);
  }

  public void set_activation_dynamics_smoothing(double value) {
    opensimActuatorsAnalysesToolsJNI.DeGrooteFregly2016Muscle_set_activation_dynamics_smoothing__SWIG_1(swigCPtr, this, value);
  }
