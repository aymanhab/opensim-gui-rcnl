...
public class Model extends ModelComponent {
  ...
  public static long swigRelease(Model obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void finalizeConnections(Component root) {
    opensimSimulationJNI.Model_finalizeConnections__SWIG_1(swigCPtr, this, Component.getCPtr(root), root);
  }
  ...
  public SWIGTYPE_p_SimTK__CableSubsystem getCableSubsystem() {
    return new SWIGTYPE_p_SimTK__CableSubsystem(opensimSimulationJNI.Model_getCableSubsystem(swigCPtr, this), false);
  }

  public SWIGTYPE_p_SimTK__CableSubsystem updCableSubsystem() {
    return new SWIGTYPE_p_SimTK__CableSubsystem(opensimSimulationJNI.Model_updCableSubsystem(swigCPtr, this), false);
  }
