...
public class Thelen2003MuscleIterator {
  ...
  public static long swigRelease(Thelen2003MuscleIterator obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void produceForces(State state, SWIGTYPE_p_OpenSim__ForceConsumer forceConsumer) {
    opensimSimulationJNI.Thelen2003MuscleIterator_produceForces(swigCPtr, this, State.getCPtr(state), state, SWIGTYPE_p_OpenSim__ForceConsumer.getCPtr(forceConsumer));
  }
  ...
  public SWIGTYPE_p_SimTK__ForceIndex getForceIndex() {
    return new SWIGTYPE_p_SimTK__ForceIndex(opensimSimulationJNI.Thelen2003MuscleIterator_getForceIndex(swigCPtr, this), true);
  }
  ...
  public ComponentPath getAbsolutePath() {
    return new ComponentPath(opensimSimulationJNI.Thelen2003MuscleIterator_getAbsolutePath(swigCPtr, this), true);
  }
  ...
  public ComponentPath getRelativePath(Component wrt) {
    return new ComponentPath(opensimSimulationJNI.Thelen2003MuscleIterator_getRelativePath(swigCPtr, this, Component.getCPtr(wrt), wrt), true);
  }
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimSimulationJNI.Thelen2003MuscleIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimSimulationJNI.Thelen2003MuscleIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public StdVectorString getSocketNames() {
    return new StdVectorString(opensimSimulationJNI.Thelen2003MuscleIterator_getSocketNames(swigCPtr, this), true);
  }

  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimSimulationJNI.Thelen2003MuscleIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimSimulationJNI.Thelen2003MuscleIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }
  ...
  public int getModelingOption(State state, String path) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public int getModelingOption(State state, ComponentPath path) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public void setModelingOption(State state, String path, int flag) {
    opensimSimulationJNI.Thelen2003MuscleIterator_setModelingOption__SWIG_0(swigCPtr, this, State.getCPtr(state), state, path, flag);
  }

  public void setModelingOption(State state, ComponentPath path, int flag) {
    opensimSimulationJNI.Thelen2003MuscleIterator_setModelingOption__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path, flag);
  }

  public double getStateVariableValue(State state, String name) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getStateVariableValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableValue(State state, ComponentPath path) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getStateVariableValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }
  ...
  public double getStateVariableDerivativeValue(State state, String name) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getStateVariableDerivativeValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableDerivativeValue(State state, ComponentPath path) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getStateVariableDerivativeValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }

  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimSimulationJNI.Thelen2003MuscleIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimSimulationJNI.Thelen2003MuscleIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.Thelen2003MuscleIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimSimulationJNI.Thelen2003MuscleIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimSimulationJNI.Thelen2003MuscleIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public SWIGTYPE_p_SimTK__CacheEntryIndex getCacheVariableIndex(String name) {
    return new SWIGTYPE_p_SimTK__CacheEntryIndex(opensimSimulationJNI.Thelen2003MuscleIterator_getCacheVariableIndex(swigCPtr, this, name), true);
  }
  ...
  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimSimulationJNI.Thelen2003MuscleIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimSimulationJNI.Thelen2003MuscleIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
  ...
  public String dump() {
    return opensimSimulationJNI.Thelen2003MuscleIterator_dump(swigCPtr, this);
  }
