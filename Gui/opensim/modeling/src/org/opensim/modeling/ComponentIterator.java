...
public class ComponentIterator {
  ...
  public static long swigRelease(ComponentIterator obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean isComponentInOwnershipTree(Component component) {
    return opensimCommonJNI.ComponentIterator_isComponentInOwnershipTree(swigCPtr, this, Component.getCPtr(component), component);
  }

  public String getAbsolutePathString() {
    return opensimCommonJNI.ComponentIterator_getAbsolutePathString(swigCPtr, this);
  }

  public ComponentPath getAbsolutePath() {
    return new ComponentPath(opensimCommonJNI.ComponentIterator_getAbsolutePath(swigCPtr, this), true);
  }

  public String getRelativePathString(Component wrt) {
    return opensimCommonJNI.ComponentIterator_getRelativePathString(swigCPtr, this, Component.getCPtr(wrt), wrt);
  }

  public ComponentPath getRelativePath(Component wrt) {
    return new ComponentPath(opensimCommonJNI.ComponentIterator_getRelativePath(swigCPtr, this, Component.getCPtr(wrt), wrt), true);
  }
  ...
  public ArrayStr getDiscreteVariableNames() {
    return new ArrayStr(opensimCommonJNI.ComponentIterator_getDiscreteVariableNames(swigCPtr, this), true);
  }

  public ArrayStr getModelingOptionNames() {
    return new ArrayStr(opensimCommonJNI.ComponentIterator_getModelingOptionNames(swigCPtr, this), true);
  }
  ...
  public OpenSimObject getConnectee(String name) {
    return new OpenSimObject(opensimCommonJNI.ComponentIterator_getConnectee__SWIG_0(swigCPtr, this, name), false);
  }

  public OpenSimObject getConnectee(String name, int index) {
    return new OpenSimObject(opensimCommonJNI.ComponentIterator_getConnectee__SWIG_1(swigCPtr, this, name, index), false);
  }

  public AbstractSocket tryGetSocket(String name) {
    long cPtr = opensimCommonJNI.ComponentIterator_tryGetSocket(swigCPtr, this, name);
  ...
  public AbstractOutput tryGetOutput(String name) {
    long cPtr = opensimCommonJNI.ComponentIterator_tryGetOutput(swigCPtr, this, name);
  ...
  public double getStateVariableValue(State state, String name) {
    return opensimCommonJNI.ComponentIterator_getStateVariableValue__SWIG_0(swigCPtr, this, State.getCPtr(state), state, name);
  }

  public double getStateVariableValue(State state, ComponentPath path) {
    return opensimCommonJNI.ComponentIterator_getStateVariableValue__SWIG_1(swigCPtr, this, State.getCPtr(state), state, ComponentPath.getCPtr(path), path);
  }
  ...
  public Component resolveVariableNameAndOwner(ComponentPath path, SWIGTYPE_p_std__string varName) {
    long cPtr = opensimCommonJNI.ComponentIterator_resolveVariableNameAndOwner(swigCPtr, this, ComponentPath.getCPtr(path), path, SWIGTYPE_p_std__string.getCPtr(varName));
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public double getDiscreteVariableValue(State state, String path) {
    return opensimCommonJNI.ComponentIterator_getDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path);
  }

  public SWIGTYPE_p_SimTK__AbstractValue getDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimCommonJNI.ComponentIterator_getDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }

  public void setDiscreteVariableValue(State state, String path, double value) {
    opensimCommonJNI.ComponentIterator_setDiscreteVariableValue(swigCPtr, this, State.getCPtr(state), state, path, value);
  }

  public SWIGTYPE_p_SimTK__AbstractValue updDiscreteVariableAbstractValue(State state, String path) {
    return new SWIGTYPE_p_SimTK__AbstractValue(opensimCommonJNI.ComponentIterator_updDiscreteVariableAbstractValue(swigCPtr, this, State.getCPtr(state), state, path), false);
  }
  ...
  public Component getRoot() {
    return new Component(opensimCommonJNI.ComponentIterator_getRoot(swigCPtr, this), false);
  }

  public Component findComponent(ComponentPath pathToFind) {
    long cPtr = opensimCommonJNI.ComponentIterator_findComponent__SWIG_0(swigCPtr, this, ComponentPath.getCPtr(pathToFind), pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }

  public Component findComponent(String pathToFind) {
    long cPtr = opensimCommonJNI.ComponentIterator_findComponent__SWIG_1(swigCPtr, this, pathToFind);
    return (cPtr == 0) ? null : new Component(cPtr, false);
  }
  ...
  public void updateXMLNode(SWIGTYPE_p_SimTK__Xml__Element parent, AbstractProperty prop) {
    opensimCommonJNI.ComponentIterator_updateXMLNode__SWIG_0(swigCPtr, this, SWIGTYPE_p_SimTK__Xml__Element.getCPtr(parent), AbstractProperty.getCPtr(prop), prop);
  }

  public void updateXMLNode(SWIGTYPE_p_SimTK__Xml__Element parent) {
    opensimCommonJNI.ComponentIterator_updateXMLNode__SWIG_1(swigCPtr, this, SWIGTYPE_p_SimTK__Xml__Element.getCPtr(parent));
  }
