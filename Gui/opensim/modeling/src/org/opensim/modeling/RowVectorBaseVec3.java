...
public class RowVectorBaseVec3 extends MatrixBaseVec3 {
  ...
  public SWIGTYPE_p_VectorIteratorT_SimTK__VecT_3_t_SimTK__RowVectorBaseT_SimTK__Vec3_t_t begin() {
    return new SWIGTYPE_p_VectorIteratorT_SimTK__VecT_3_t_SimTK__RowVectorBaseT_SimTK__Vec3_t_t(opensimSimbodyJNI.RowVectorBaseVec3_begin(swigCPtr, this), true);
  }

  public SWIGTYPE_p_VectorIteratorT_SimTK__VecT_3_t_SimTK__RowVectorBaseT_SimTK__Vec3_t_t end() {
    return new SWIGTYPE_p_VectorIteratorT_SimTK__VecT_3_t_SimTK__RowVectorBaseT_SimTK__Vec3_t_t(opensimSimbodyJNI.RowVectorBaseVec3_end(swigCPtr, this), true);
  }
