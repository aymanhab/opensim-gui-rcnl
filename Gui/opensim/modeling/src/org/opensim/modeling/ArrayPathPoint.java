...
public class ArrayPathPoint {
  ...
  public ArrayPathPoint(AbstractPathPoint aDefaultValue, int aSize, int aCapacity) {
    this(opensimSimulationJNI.new_ArrayPathPoint__SWIG_2(AbstractPathPoint.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayPathPoint(AbstractPathPoint aDefaultValue, int aSize) {
    this(opensimSimulationJNI.new_ArrayPathPoint__SWIG_3(AbstractPathPoint.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayPathPoint(AbstractPathPoint aDefaultValue) {
    this(opensimSimulationJNI.new_ArrayPathPoint__SWIG_4(AbstractPathPoint.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayPathPoint() {
    this(opensimSimulationJNI.new_ArrayPathPoint__SWIG_5(), true);
  }
