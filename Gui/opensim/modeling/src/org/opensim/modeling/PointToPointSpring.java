...
public class PointToPointSpring extends Force {
  ...
  public static long swigRelease(PointToPointSpring obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setPropertyIndex_socket_body1(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.PointToPointSpring_PropertyIndex_socket_body1_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_body1() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.PointToPointSpring_PropertyIndex_socket_body1_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_socket_body2(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.PointToPointSpring_PropertyIndex_socket_body2_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_body2() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.PointToPointSpring_PropertyIndex_socket_body2_get(swigCPtr, this), true);
  }
