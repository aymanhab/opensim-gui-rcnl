...
public class DataTableVec3 extends AbstractDataTable {
  ...
  public void appendRow(double indRow, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t container) {
    opensimCommonJNI.DataTableVec3_appendRow__SWIG_0(swigCPtr, this, indRow, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t.getCPtr(container));
  }

  public void appendRow(double indRow, RowVectorVec3 depRow) {
    opensimCommonJNI.DataTableVec3_appendRow__SWIG_1(swigCPtr, this, indRow, RowVectorVec3.getCPtr(depRow), depRow);
  }

  public void appendRow(double indRow, RowVectorViewVec3 depRow) {
    opensimCommonJNI.DataTableVec3_appendRow__SWIG_2(swigCPtr, this, indRow, RowVectorViewVec3.getCPtr(depRow), depRow);
  }
  ...
  public void appendColumn(String columnLabel, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t container) {
    opensimCommonJNI.DataTableVec3_appendColumn__SWIG_0(swigCPtr, this, columnLabel, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t.getCPtr(container));
  }

  public void appendColumn(String columnLabel, VectorVec3 depCol) {
    opensimCommonJNI.DataTableVec3_appendColumn__SWIG_1(swigCPtr, this, columnLabel, VectorVec3.getCPtr(depCol), depCol);
  }

  public void appendColumn(String columnLabel, VectorViewVec3 depCol) {
    opensimCommonJNI.DataTableVec3_appendColumn__SWIG_2(swigCPtr, this, columnLabel, VectorViewVec3.getCPtr(depCol), depCol);
  }
