...
public class PointOnLineConstraint extends Constraint {
  ...
  public static long swigRelease(PointOnLineConstraint obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setPropertyIndex_socket_line_body(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.PointOnLineConstraint_PropertyIndex_socket_line_body_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_line_body() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.PointOnLineConstraint_PropertyIndex_socket_line_body_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_socket_follower_body(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimSimulationJNI.PointOnLineConstraint_PropertyIndex_socket_follower_body_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_follower_body() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimSimulationJNI.PointOnLineConstraint_PropertyIndex_socket_follower_body_get(swigCPtr, this), true);
  }
