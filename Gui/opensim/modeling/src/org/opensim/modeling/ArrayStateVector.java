...
public class ArrayStateVector {
  ...
  public ArrayStateVector(StateVector aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayStateVector__SWIG_2(StateVector.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayStateVector(StateVector aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayStateVector__SWIG_3(StateVector.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayStateVector(StateVector aDefaultValue) {
    this(opensimCommonJNI.new_ArrayStateVector__SWIG_4(StateVector.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayStateVector() {
    this(opensimCommonJNI.new_ArrayStateVector__SWIG_5(), true);
  }
