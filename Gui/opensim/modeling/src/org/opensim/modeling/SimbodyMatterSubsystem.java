...
public class SimbodyMatterSubsystem {
  ...
  public void calcFrameJacobian(State state, int onBodyB, Vec3 originAoInB, SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_2_SimTK__Vec3_t_t JF) {
    opensimSimbodyJNI.SimbodyMatterSubsystem_calcFrameJacobian__SWIG_1(swigCPtr, this, State.getCPtr(state), state, onBodyB, Vec3.getCPtr(originAoInB), originAoInB, SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_2_SimTK__Vec3_t_t.getCPtr(JF));
  }
