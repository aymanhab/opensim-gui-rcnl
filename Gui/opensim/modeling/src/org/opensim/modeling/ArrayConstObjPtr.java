...
public class ArrayConstObjPtr {
  ...
  public ArrayConstObjPtr(OpenSimObject aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayConstObjPtr__SWIG_2(OpenSimObject.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayConstObjPtr(OpenSimObject aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayConstObjPtr__SWIG_3(OpenSimObject.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayConstObjPtr(OpenSimObject aDefaultValue) {
    this(opensimCommonJNI.new_ArrayConstObjPtr__SWIG_4(OpenSimObject.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayConstObjPtr() {
    this(opensimCommonJNI.new_ArrayConstObjPtr__SWIG_5(), true);
  }
