...
public class ToyPropMyoController extends Controller {
  ...
  public static long swigRelease(ToyPropMyoController obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setPropertyIndex_socket_actuator(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimExampleComponentsJNI.ToyPropMyoController_PropertyIndex_socket_actuator_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_socket_actuator() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimExampleComponentsJNI.ToyPropMyoController_PropertyIndex_socket_actuator_get(swigCPtr, this), true);
  }
  ...
  public void setPropertyIndex_input_activation(SWIGTYPE_p_OpenSim__PropertyIndex value) {
    opensimExampleComponentsJNI.ToyPropMyoController_PropertyIndex_input_activation_set(swigCPtr, this, SWIGTYPE_p_OpenSim__PropertyIndex.getCPtr(value));
  }

  public SWIGTYPE_p_OpenSim__PropertyIndex getPropertyIndex_input_activation() {
    return new SWIGTYPE_p_OpenSim__PropertyIndex(opensimExampleComponentsJNI.ToyPropMyoController_PropertyIndex_input_activation_get(swigCPtr, this), true);
  }
