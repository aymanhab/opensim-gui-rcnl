...
public class MomentArmSolver extends Solver {
  ...
  public static long swigRelease(MomentArmSolver obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public double solve(State state, Coordinate coordinate, AbstractGeometryPath path) {
    return opensimSimulationJNI.MomentArmSolver_solve__SWIG_0(swigCPtr, this, State.getCPtr(state), state, Coordinate.getCPtr(coordinate), coordinate, AbstractGeometryPath.getCPtr(path), path);
  }
