...
public class InputVec3 extends AbstractInput {
  ...
  public static long swigRelease(InputVec3 obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_OpenSim__OutputT_SimTK__VecT_3_t_t__Channel getChannel() {
    return new SWIGTYPE_p_OpenSim__OutputT_SimTK__VecT_3_t_t__Channel(opensimCommonJNI.InputVec3_getChannel__SWIG_0(swigCPtr, this), false);
  }

  public SWIGTYPE_p_OpenSim__OutputT_SimTK__VecT_3_t_t__Channel getChannel(long index) {
    return new SWIGTYPE_p_OpenSim__OutputT_SimTK__VecT_3_t_t__Channel(opensimCommonJNI.InputVec3_getChannel__SWIG_1(swigCPtr, this, index), false);
  }
