...
public class ArrayVec3 {
  ...
  public ArrayVec3(SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t initList) {
    this(opensimCommonJNI.new_ArrayVec3__SWIG_2(SWIGTYPE_p_std__initializer_listT_SimTK__VecT_3_t_t.getCPtr(initList)), true);
  }

  public ArrayVec3(Vec3 aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayVec3__SWIG_3(Vec3.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayVec3(Vec3 aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayVec3__SWIG_4(Vec3.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayVec3(Vec3 aDefaultValue) {
    this(opensimCommonJNI.new_ArrayVec3__SWIG_5(Vec3.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayVec3() {
    this(opensimCommonJNI.new_ArrayVec3__SWIG_6(), true);
  }
