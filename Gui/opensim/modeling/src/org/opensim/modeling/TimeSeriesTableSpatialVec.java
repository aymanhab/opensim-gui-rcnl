...
public class TimeSeriesTableSpatialVec extends DataTableSpatialVec {
  ...
  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t getNearestRow(double time, boolean restrictToTimeRange) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t(opensimCommonJNI.TimeSeriesTableSpatialVec_getNearestRow__SWIG_0(swigCPtr, this, time, restrictToTimeRange), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t getNearestRow(double time) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t(opensimCommonJNI.TimeSeriesTableSpatialVec_getNearestRow__SWIG_1(swigCPtr, this, time), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t updNearestRow(double time, boolean restrictToTimeRange) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t(opensimCommonJNI.TimeSeriesTableSpatialVec_updNearestRow__SWIG_0(swigCPtr, this, time, restrictToTimeRange), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t updNearestRow(double time) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_2_SimTK__Vec3_t_t(opensimCommonJNI.TimeSeriesTableSpatialVec_updNearestRow__SWIG_1(swigCPtr, this, time), true);
  }

  public SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_2_SimTK__Vec3_t_t averageRow(double beginTime, double endTime) {
    return new SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_2_SimTK__Vec3_t_t(opensimCommonJNI.TimeSeriesTableSpatialVec_averageRow(swigCPtr, this, beginTime, endTime), true);
  }
  ...
  public void trimToIndices(long start_index, long last_index) {
    opensimCommonJNI.TimeSeriesTableSpatialVec_trimToIndices(swigCPtr, this, start_index, last_index);
  }
