...
public class RowVectorBaseVec6 extends MatrixBaseVec6 {
  ...
  public static long swigRelease(RowVectorBaseVec6 obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_VectorIteratorT_SimTK__VecT_6_t_SimTK__RowVectorBaseT_SimTK__Vec6_t_t begin() {
    return new SWIGTYPE_p_VectorIteratorT_SimTK__VecT_6_t_SimTK__RowVectorBaseT_SimTK__Vec6_t_t(opensimSimbodyJNI.RowVectorBaseVec6_begin(swigCPtr, this), true);
  }

  public SWIGTYPE_p_VectorIteratorT_SimTK__VecT_6_t_SimTK__RowVectorBaseT_SimTK__Vec6_t_t end() {
    return new SWIGTYPE_p_VectorIteratorT_SimTK__VecT_6_t_SimTK__RowVectorBaseT_SimTK__Vec6_t_t(opensimSimbodyJNI.RowVectorBaseVec6_end(swigCPtr, this), true);
  }
