...
public class ArrayPointForceDirection {
  ...
  public static long swigRelease(ArrayPointForceDirection obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ArrayPointForceDirection(ArrayPointForceDirection arg0) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_0(ArrayPointForceDirection.getCPtr(arg0), arg0), true);
  }

  public ArrayPointForceDirection(SWIGTYPE_p_std__initializer_listT_OpenSim__PointForceDirection_p_t initList) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_2(SWIGTYPE_p_std__initializer_listT_OpenSim__PointForceDirection_p_t.getCPtr(initList)), true);
  }

  public ArrayPointForceDirection(PointForceDirection aDefaultValue, int aSize, int aCapacity) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_3(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayPointForceDirection(PointForceDirection aDefaultValue, int aSize) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_4(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayPointForceDirection(PointForceDirection aDefaultValue) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_5(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayPointForceDirection() {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_6(), true);
  }
