...
public class ArrayPointForceDirection {
  ...
  public ArrayPointForceDirection(PointForceDirection aDefaultValue, int aSize, int aCapacity) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_2(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayPointForceDirection(PointForceDirection aDefaultValue, int aSize) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_3(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue, aSize), true);
  }

  public ArrayPointForceDirection(PointForceDirection aDefaultValue) {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_4(PointForceDirection.getCPtr(aDefaultValue), aDefaultValue), true);
  }

  public ArrayPointForceDirection() {
    this(opensimSimulationJNI.new_ArrayPointForceDirection__SWIG_5(), true);
  }
