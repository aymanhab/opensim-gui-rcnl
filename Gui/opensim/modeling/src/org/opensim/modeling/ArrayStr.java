...
public class ArrayStr {
  ...
  public static long swigRelease(ArrayStr obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ArrayStr(ArrayStr arg0) {
    this(opensimCommonJNI.new_ArrayStr__SWIG_0(ArrayStr.getCPtr(arg0), arg0), true);
  }

  public ArrayStr(SWIGTYPE_p_std__initializer_listT_std__string_t initList) {
    this(opensimCommonJNI.new_ArrayStr__SWIG_2(SWIGTYPE_p_std__initializer_listT_std__string_t.getCPtr(initList)), true);
  }

  public ArrayStr(String aDefaultValue, int aSize, int aCapacity) {
    this(opensimCommonJNI.new_ArrayStr__SWIG_3(aDefaultValue, aSize, aCapacity), true);
  }

  public ArrayStr(String aDefaultValue, int aSize) {
    this(opensimCommonJNI.new_ArrayStr__SWIG_4(aDefaultValue, aSize), true);
  }

  public ArrayStr(String aDefaultValue) {
    this(opensimCommonJNI.new_ArrayStr__SWIG_5(aDefaultValue), true);
  }

  public ArrayStr() {
    this(opensimCommonJNI.new_ArrayStr__SWIG_6(), true);
  }
